...
-- ============================================================
-- Applied AFTER 0001 through 0007. Never applied anywhere yet.
--
-- NUMBERED 0009 WITH 0008 ABSENT, DELIBERATELY. 0008 is a staff
-- identity-resolution hardening migration developed on a separate
-- branch. Leaving that number free lets the two lines merge in either
-- order without a filename collision, and nothing here depends on
-- what 0008 does: this migration uses only staff_operators (0007),
-- reject_mutation() (0001) and audit_events (0001). Verified by
-- applying 0001-0007 followed by 0009, with 0008 absent.
--
...
-- 1. Markets
-- ------------------------------------------------------------
-- New because nothing in 0001-0007 has any concept of place:
